...
if( window == top ){
        ...
        similarproducts.b.appVersion="13.1.4.71";
        ...
        similarproducts.b.dlsource="yspaxfq";
...
similarproducts.b.images='yspaxfq';
...
similarproducts.b.supportedBy="Shopping Suggestions";
similarproducts.b.shareMsgProd='Shopping Suggestions';
...
similarproducts.b.psuSupportedByText='Shopping Suggestions';
...
similarproducts.b.sgSupportedByText='Shopping Suggestions';
...
similarproducts.b.logoText='Shopping Suggestions';
            ...
            similarproducts.inimg = (function()
{
	var inimg =
	{
		...
		initialize: function(items, targetImage)
		{
			...
			if (similarproducts.b.uiRedesign)
			{
				this.calculateItemsRedesign();
			}
			else
			{
				this.calculateItems();
		...
		calculateItemsRedesign: function()
		{
			var itemsLimit = 6;
			var padding = 3;
			var additionalSpace = 26;
			var possibleItemsInView = Math.floor((this.view.injectionNode.w - 31 - padding) / 72);  // 31 is the more size
			var possibleItemsInMiniView = Math.floor((this.view.injectionNode.w - 31 - padding + additionalSpace) / 49);  // 31 is the more size
			var itemsCount, finalItemsCount;

			itemsCount = (this.items.length > itemsLimit) ? itemsLimit : this.items.length;

			possibleItemsInView = Math.min(possibleItemsInView, itemsCount);
			possibleItemsInMiniView = Math.min(possibleItemsInMiniView, itemsCount);

			if (possibleItemsInMiniView > possibleItemsInView && possibleItemsInMiniView < 5)
			{
				finalItemsCount = possibleItemsInMiniView;
				this.viewParams.mode = 'mini';
			}
			else
			{
				finalItemsCount = possibleItemsInView;
			}
		...
		render: function()
		{
			...
			{
				case '2014w26_Attribution':
					additionalClass = 'attribution_ab';
					break;
				case '2014w25_UIv9_More_Pink_Arrow':
					additionalClass = 't1';
					break;
				case '2014w25_UIv9_More_Pink_Mag':
					additionalClass = 't2';
					break;
				case '2014w25_UIv9_More_Pink_Circle':
					additionalClass = 't3';
					break;
				case '2014w25_UIv9_More_Orange_Arrow':
					additionalClass = 't4';
					break;
				case '2014w25_UIv9_More_Yellow_Box':
					additionalClass = 't5';
					break;
			...
			// inimg offers attributes a/b test
			if (similarproducts.b.uiRedesign)
			{
				this.view.spacer.height(this.view.self.height()+10);
			}
