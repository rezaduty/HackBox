	...
	spsupport.api = {
		...
		normalFlow: function()
		{
			...
			if (!spsupport.sites.isBlackStage())
			{
				...
				if (testBucket == '2014w25_UIv9_More_Pink_Arrow'
					|| testBucket == '2014w25_UIv9_More_Pink_Mag'
					|| testBucket == '2014w25_UIv9_More_Pink_Circle'
					|| testBucket == '2014w25_UIv9_More_Orange_Arrow'
					|| testBucket == '2014w25_UIv9_More_Yellow_Box')
				{
