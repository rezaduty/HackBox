...
###################################################
#Author      : Burtay                             #
#Site        : http://Burtay.Org                  #
#Date        : 09.06.2011                         #
#Location    : Istanbul , Turkey                  #
#Thanks      : RmX,F0RTYS3V3N,silnt hill          #
###################################################
error_reporting(0);
set_time_limit(0);
if($argc <=2 or $argc>=4)
die("\nSomethins Wrong\nusage php wp-hash.php HASH WORDLIST.TXT\n#Coded By Burtay\n#Burtay.Org | hack-book.Net | Tryag.cc | xp10.com\n");
$wp_hasher_burtay = new PasswordHash(8, TRUE);
$aranan		=	$argv[1];
$wordlist	=	$argv[2];
$oku		=	file($wordlist);
foreach($oku as $tek)
{	
	if($wp_hasher_burtay->CheckPassword(trim($tek), $aranan)) 
	{
	   echo "[+]FOUND Ohhh Shit->".$tek."\n";
	   die("\nCoded By Burtay\Burtay.Org | hack-book.Net | Tryag.cc | xp10.com\n");
	}
	else 
	{
	   echo "[+]Testing -> ".trim($tek)."\n";
	}
}
?>
<?php
