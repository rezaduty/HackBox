<html>
<head>
<title>AWARDSPACE.COM - Free Web Hosting, Domain Hosting, Reliable Web Hosting Provider, Domain registration, Inexpensive, Low Cost, Affordable, Reseller Program, PHP, MySQL, Linux, Ecommerce</title>
...
<meta name="Author" content="AWARDSPACE.COM - Web Hosting, Domain Name Registration, Inexpensive, Low Cost, Affordable, Reliable Provider, Reseller Program, PHP, MySQL, Linux, Ecommerce">
<meta name="Creator" content="ZETTA HOSTING SOLUTIONS">
<meta name="Copyright" content="Copyright 2003 - 2006 ZETTA HOSTING SOLUTIONS. All rights reserved.">
<meta name="Publisher" content="ZETTA HOSTING SOLUTIONS">
<meta name="Owner" content="ZETTA HOSTING SOLUTIONS">
...
<style type="text/css">
    ...
    .header_table {background: #0080C0; font-family: Arial, Helvetica, sans-serif}
    img {border: 0}
    -->
</style>
    ...
    <tr>
      <td>
        <table width="100%" cellpadding="0" cellspacing="1" border="0" class="header_table">
          <tr>
            <td width="100" bgcolor="#FFFFFF"><img src="/notes/awardspace.gif" title="AWARDSPACE.COM - Your winning web hosting provider" border="0" width="150" height="20"></td>
            <td bgcolor="#FFFFFF" align="center">
<img src="/notes/403.jpg" width="140" height="20"></td>
            <td width="210" bgcolor="#FFFFFF" class="text" style="padding-left: 10px" nowrap>Your winning web hosting provider</td>
          </tr>
        </table>
      </td>
    </tr>
